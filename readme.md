...
1. **[Dynamic](./markdown/recursion_and_dynamic/dynamic_programming.md):** fibonacci, combination sum (find/count combinations), three-step, knapsack, count sqr submatrices, maximal sqr, longest string chain
